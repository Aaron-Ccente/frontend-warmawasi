"use client";
import ComoLlegar from "@/components/Location/ComoLlegar";
import Mapa from "@/components/Location/Mapa";
import Sedes from "@/components/Location/Sedes";
