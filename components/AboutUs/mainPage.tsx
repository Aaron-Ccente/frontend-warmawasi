...
function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-white to-[#fdf2f8]">
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-8 lg:px-12 relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Sobre <span className="text-[#ffd6e7]">Warma Wasi</span>
            </h1>
            <p className="text-xl md:text-2xl max-w-3xl mx-auto text-gray-100 leading-relaxed">
              Más de una década brindando cuidado, amor y dignidad a nuestros
              adultos mayores
            </p>
          </motion.div>
        </div>
      ...
      {/* Componente de Historia del negocio */}
      <Historia />

      {/* Componenten de Nuestros Valores */}
      <Valores />

      {/* Componente de Equipo Profesional */}
      <Team />
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <h2 className="text-3xl font-bold text-[#9f2161] mb-4">
              Un Hogar Donde Se Sientan Cuidados
            </h2>
            <p className="text-gray-700 text-lg mb-8 max-w-2xl mx-auto">
              En Warma Wasi, cada día trabajamos para ser el hogar que su
              familiar merece, combinando cuidado profesional con calidez
              humana.
            </p>
